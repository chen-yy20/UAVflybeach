...
void receive_deal_func()
{
    ...
    //A1
    anchorArray[1].x = 0.0; //anchor2.x uint:m
    anchorArray[1].y = 1.6; //anchor2.y uint:m
    anchorArray[1].z = 0.0;
    //A20
    anchorArray[2].x = 0.8; //anchor2.x uint:m
    anchorArray[2].y = 0.8; //anchor2.y uint:m
    anchorArray[2].z = 0.65; //anchor2.z uint:m
